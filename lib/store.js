...
/** @type {typeof import('@sampandey001/baileys')} */ // @ts-ignore
const {
  initAuthCreds,
  BufferJSON,
  proto,
...
function makeInMemoryStore() {
  /** @type {{ [jid: string]: { id: string, lastfetch?: number, subject?: string, name?: string, isChats?: boolean, isContact?: boolean, presence?: import('@sampandey001/baileys').PresenceData, metadata?: import('@sampandey001/baileys').GroupMetadata } & import('@sampandey001/baileys').Chat & import('@sampandey001/baileys').Contact }}} */
  let chats = {};
  /** @type {{ [jid: string]: import('@sampandey001/baileys').proto.WebMessageInfo[] }} */
  let messages = {};
  /** @type {import('@sampandey001/baileys').ConnectionState} */
  ...
  function loadMessage(jid, id = null) {
    ...
    if (jid && !id) {
      id = jid;
      /** @type {(m: import('@sampandey001/baileys').proto.WebMessageInfo) => Boolean} */
  ...
  /**
   * @param {string} jid
   * @param {(jid: string) => Promise<import('@sampandey001/baileys').GroupMetadata> | null} groupMetadata
   */
  ...
  /**
   * @param {string} jid
   * @param {import('@sampandey001/baileys').proto.WebMessageInfo} message
   */
  ...
  /**
   * @param {import('@sampandey001/baileys').BaileysEventEmitter} ev
   * @param {{ groupMetadata: (jid: string, minimal?: boolean) => Promise<import('@sampandey001/baileys').GroupMetadata> | null }} opts
   */
      ...
      for (const chat of chatsSet.chats) {
        ...
        if (!(id in chats))
          chats[id] = {
            ...chat,
            isChats: true,
            ...(chat.name ? { name: /** @type {String} */ (chat.name) } : {}),
          };
...
/**
 *
 * @returns {ReturnType<typeof import('@sampandey001/baileys').useSingleFileAuthState>}
 */
