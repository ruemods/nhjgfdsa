...
const { jidDecode, delay } = require("@sampandey001/baileys");
const { spawn } = require("child_process");
const FormData = require("form-data");
const fetch = require("node-fetch");
const acrcloud = require('./acr')
const {IgDl} = require("./scrapers")
...
module.exports = {
  ...
  AddMp3Meta: async (
    songbuffer,
    coverBuffer,
    options = { title: "Aswin-MD Whatsapp bot", artist: ["Aswin-MD"] }
  ) => {
    ...
    writer
      ...
      .setFrame("TPE1", ["Aswin-MD"])
      .setFrame("APIC", {
        type: 3,
        data: coverBuffer,
        description: "Aswin-MD Public Bot",
      });
    writer.addTag();
